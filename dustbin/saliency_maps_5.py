...
for i, (images, labels) in enumerate(test_loader):
    ...
    for j in range(dist.size(0)):  # Iterate over the images in the batch
        ...
        _, most_influential_indices = torch.topk(distances.abs(), 8)
        
        # Print the true and predicted labels along with the most influential concept names and their distances
        ...
        for idx in most_influential_indices:
            concept_name = sorted_concept_list[idx]
            concept_distance = distances[idx].item()
