...
class ModelWrapper(nn.Module):
    def __init__(self, classifier, clip_model, resolution):
        ...
        self.classifier = classifier ## now pcbm
...
#hpcbm saved as full model 
classifier = torch.load('/data/gpfs/projects/punim2103/joint_training/finetuning_both_40_epochs_different_lr/pcbm-hybrid_finetuned_-1_cliplayers_1e-07_clip_lr_1e-07_pcbm_lr.pth', map_location=device)
...
csv_path = f'/data/gpfs/projects/punim2103/results_clean/finetuned_models/pcbm_40_epochs_adv_and_orig/hpcbm/csv/eps_{epsilon}_after_batch_8.csv'
batch = 0
results = []
...
with open(csv_path, 'w', newline='') as csvfile:
    ...
    for images, labels in test_loader:
        ...
        if batch <= 8:  # Skip the first 8 batches
            continue
        ...
        torch.save(x_adv, f'/data/gpfs/projects/punim2103/results_clean/finetuned_models/pcbm_40_epochs_adv_and_orig/hpcbm/images/eps_{epsilon}_batch_{batch}_adv.pt')
