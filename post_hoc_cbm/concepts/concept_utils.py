...
#packages_to_install = ['scikit-learn', 'numpy', 'pandas']  # Add more packages as needed
...
# You can also specify a version by appending '==version' to the package name, e.g., 'scikit-learn==1.3.0'
