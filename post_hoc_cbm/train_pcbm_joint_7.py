...
def config():
    ...
    parser.add_argument("--learning-rate", default=1e-7, type=float)
...
def main(args):
    ...
    clip_scheduler = cosine_lr(clip_optimizer, args.learning_rate, args.warmup, total_steps)
    pcbm_scheduler = cosine_lr(pcbm_optimizer, args.learning_rate, args.warmup, total_steps)
