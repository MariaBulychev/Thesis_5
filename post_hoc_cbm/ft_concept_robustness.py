...
classifier = torch.load('/data/gpfs/projects/punim2103/train_results/pcbm_cifar10__clip:RN50__broden_clip:RN50_0__lam:0.0002__alpha:0.99__seed:42.ckpt', map_location=device)
...
adversarial_dir = "/data/gpfs/projects/punim2103/results_clean/finetuned_models/pcbm_40_epochs_adv_and_orig/images"
...
results_df.to_csv("/data/gpfs/projects/punim2103/results_clean/finetuned_models/pcbm_40_epochs_adv_and_orig/csv/concept_robustness_test.csv", index=False)