...
def main(args):
    ...
    save_dir = "/data/gpfs/projects/punim2103/joint_training/finetuning_only_clip_adv_and_orig_20_epochs"
    ...
    for epoch in range(args.num_epochs):
        ...
        for inputs, labels in train_loader:
            ...
            # Forward pass
            with autocast():    
                outputs_orig = probe_model(inputs)
                ...
                images = inputs + delta
                outputs_adv = probe_model(images)
