...
def main(args):
    ...
    # Load PCBM
    h_pcbm = torch.load('/data/gpfs/projects/punim2103/joint_training/finetuning_both_40_epochs_different_lr/pcbm-hybrid_finetuned_-1_cliplayers_1e-07_clip_lr_1e-07_pcbm_lr.pth', map_location=device)
