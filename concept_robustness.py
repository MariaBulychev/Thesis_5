...
adversarial_dir = "/data/gpfs/projects/punim2103/autoattack_results/l_inf/hybrid_pcbm_3/eps_0.001"
...
for i, (data, batch_file) in enumerate(zip(test_loader, adversarial_batches)):
...
results_df = pd.DataFrame(results, columns=['Image Index', 'Correct', 'Predicted Orig', 'Predicted Adv', 'Top-5', 'Top-10', 'Top-15', 'Top-20', 'Top-50'])
results_df.to_csv("/data/gpfs/projects/punim2103/concept_robustness_results.csv", index=False)