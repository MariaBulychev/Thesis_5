...
# Loop over the two epsilon values
for epsilon in [0.0005, 0.00001]:
    adversary = AutoAttack(wrapped_model, norm='Linf', eps=epsilon, version='standard', device=device)

    csv_path = f'/data/gpfs/projects/punim2103/csv/original_model_new_attempt_4_results_eps_{epsilon}.csv'
    batch = 0
    results = []
